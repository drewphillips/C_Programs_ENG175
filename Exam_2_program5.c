...
(2 pts) read in vector A and vector B elements
(3 pts) display a menu to select one of the four vector calculations
          in each case, print "you chose ___"
          no formulas or calculations in the add, sub, scalar cases
(-3 of 3 pts) only in the magnitude case, calculate and print magnitude of A and magnitude of B  code prints s and 6
          Test case: (4, -5) and (7, 8)  MagA = 6.403  MagB = 10.630
(2 pts) loop the menu
do not loop until the user wants to quit
*/